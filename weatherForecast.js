function weather() {
    ...
    let response1 = fetch("https://api.openweathermap.org/data/2.5/weather?q=" + city.value + "&appid=930a1ba727a99be0ffe9c24abd87902d")
    response1.then((res) => {
        res.json().then((data) => {
    ...
    let response2 = fetch("https://api.openweathermap.org/data/2.5/forecast?q=" + city.value + "&appid=930a1ba727a99be0ffe9c24abd87902d")
    response2.then((res) => {
        res.json().then((data) => {
            let j = 0;
            var temp = [];
